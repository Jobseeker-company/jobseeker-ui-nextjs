...
export interface BaseAsyncSelectProps<T extends BaseAction> extends Omit<React.HTMLAttributes<HTMLDivElement>, 'children' | 'onChange' | 'value'> {
    action: T;
...
export interface BaseAsyncMultiSelectProps<T extends BaseAction> extends Omit<BaseAsyncSelectProps<T>, 'onValueChange' | 'onChange' | 'value'> {
    value?: OptionProps[];
    onValueChange?: (value: OptionProps[]) => void;
    onChange?: (value: OptionProps[]) => void;
}
export declare function CoreAsyncSelectFn<T extends BaseAction>(props: CoreAsyncSelectProps<T>): JSX.Element;
export interface CoreAsyncSelectProps<T extends BaseAction> extends Omit<BaseAsyncSelectProps<T>, 'name'> {
    open: boolean;
}
export declare function CoreAsyncMultiSelectFn<T extends BaseAction>(props: CoreAsyncMultiSelectProps<T>): JSX.Element;
export interface CoreAsyncMultiSelectProps<T extends BaseAction> extends Omit<BaseAsyncMultiSelectProps<T>, 'name'> {
    open: boolean;
}
