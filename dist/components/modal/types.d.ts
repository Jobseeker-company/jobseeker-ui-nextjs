...
export type ModalHeaderProps<C extends React.ElementType = 'div'> = React.ComponentProps<C> & React.PropsWithChildren<{
    as?: C;
    onClose?: () => void;
    className?: string;
...
export declare function SideModalFn<C extends React.ElementType = 'div'>(props: SideModalProps<C>): JSX.Element;
export type SideModalProps<C extends React.ElementType = 'div'> = React.ComponentProps<C> & {
    as?: C;
